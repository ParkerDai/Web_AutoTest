...
class SecurityChangepassword1(unittest.TestCase):
    def setUp(self):
    ...
    def test_security_changepassword1(self):
        driver = self.driver
        ...
        driver.find_element_by_name("txtOldPwd").send_keys("")
        # [New Password]
        driver.find_element_by_name("txtNewPwd").clear()
        driver.find_element_by_name("txtNewPwd").send_keys("admin")
        # [Verified Password]
        driver.find_element_by_name("txtVerPwd").clear()
        driver.find_element_by_name("txtVerPwd").send_keys("admin")
        # [Save Password]
