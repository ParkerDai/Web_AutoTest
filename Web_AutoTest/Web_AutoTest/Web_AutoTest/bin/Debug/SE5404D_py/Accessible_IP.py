...
class Test(unittest.TestCase):
    def setUp(self):
        ...
        self.base_url = "http://10.0.50.105/"
    ...
    def test_(self):
        ...
        # ERROR: Caught exception [ERROR: Unsupported command [selectFrame | rbottom | ]]
        # ERROR: Caught exception [ERROR: Unsupported command [selectWindow | name=left | ]]
        ...
        driver.find_element_by_name("ckIPFilter").click()
